...
class HTSUtils {
    ...
    static ChannelTag convertMessageToChannelTagModel(@NonNull ChannelTag tag, @NonNull HTSMessage msg, @NonNull List<Channel> channels) {
    ...
    static Channel convertMessageToChannelModel(@NonNull Channel channel, @NonNull HTSMessage msg) {
    ...
    static Recording convertMessageToRecordingModel(@NonNull Recording recording, @NonNull HTSMessage msg) {
    ...
    static Program convertMessageToProgramModel(@NonNull Program program, @NonNull HTSMessage msg) {
        if (msg.containsKey("eventId")) {
    ...
    static SeriesRecording convertMessageToSeriesRecordingModel(@NonNull SeriesRecording seriesRecording, @NonNull HTSMessage msg) {
        if (msg.containsKey("id")) {
    ...
    static TimerRecording convertMessageToTimerRecordingModel(@NonNull TimerRecording timerRecording, @NonNull HTSMessage msg) {
        if (msg.containsKey("id")) {
    ...
    static HTSMessage convertIntentToAutorecMessage(@NonNull Intent intent, int htspVersion) {
    ...
    static HTSMessage convertIntentToDvrMessage(@NonNull Intent intent, int htspVersion) {
    ...
    static HTSMessage convertIntentToTimerecMessage(@NonNull Intent intent, int htspVersion) {
        final long enabled = intent.getIntExtra("enabled", 1);
        final String title = intent.getStringExtra("title");
        final String directory = intent.getStringExtra("directory");
        final String name = intent.getStringExtra("name");
    ...
    static ServerStatus convertMessageToServerStatusModel(@NonNull ServerStatus serverStatus, @NonNull HTSMessage msg) {
