...
public class SeriesRecording {
    ...
    private long start = time;                  // s32   required   Exact start time (minutes from midnight) (Added in version 18).
    @ColumnInfo(name = "start_window")
    private long startWindow = time + offset;   // s32   required   Exact stop time (minutes from midnight) (Added in version 18).
