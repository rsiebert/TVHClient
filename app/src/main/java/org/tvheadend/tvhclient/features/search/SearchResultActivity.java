...
*/
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        final boolean showGenreColors = prefs.getBoolean("genre_color_for_programs_enabled", false);
        ...
        switch (item.getItemId()) {
            ...
            */
            ...
            case R.id.menu_record_once_custom_profile:
                ...
                menuUtils.handleMenuCustomRecordSelection(program.getEventId(), channel.getId());
                return true;
