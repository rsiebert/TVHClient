...
/* package */ final class EventLogger implements Player.EventListener,
    ...
    public void onRepeatModeChanged(int i) {
        Timber.d("repeatModeChanged [" + getSessionTimeString() + "]");
    }
    ...
    public void onVideoInputFormatChanged(Format format) {
        Timber.d("videoFormatChanged [" + getSessionTimeString() + ", " + getFormatString(format)
                + "]");
    }
    ...
    public void onVideoSizeChanged(int width, int height, int unappliedRotationDegrees,
        ...
        Timber.d("videoSizeChanged [" + getSessionTimeString() + ", " + width + ", " + height + ", "
