...
public class ChannelViewModel extends AndroidViewModel {
    ...
    public ChannelViewModel(Application application) {
        ...
        //AsyncTask.execute(() ->  {
            ...
            channelSortOrder.postValue(Integer.valueOf(sharedPreferences.getString("channel_sort_order", application.getResources().getString(R.string.pref_default_channel_sort_order))));
