...
public class RemovedRecordingListFragment extends RecordingListFragment implements FragmentControlInterface {
     ...
     */
    public RemovedRecordingListFragment() {
        TAG = RemovedRecordingListFragment.class.getSimpleName();
    }
    ...
    private void populateList() {
        ...
        adapter.clear();
        for (Recording rec : app.getRecordingsByType(Constants.RECORDING_TYPE_REMOVED)) {
            adapter.add(rec);
        }
        ...
        if (actionBarInterface != null) {
            actionBarInterface.setActionBarTitle(getString(R.string.removed_recordings));
