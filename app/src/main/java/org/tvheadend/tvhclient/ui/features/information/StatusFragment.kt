...
class StatusFragment : BaseFragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        statusViewModel = ViewModelProvider(activity!!).get(StatusViewModel::class.java)
        ...
        baseViewModel.connectionToServerAvailable.observe(viewLifecycleOwner, Observer { connectionAvailable ->
