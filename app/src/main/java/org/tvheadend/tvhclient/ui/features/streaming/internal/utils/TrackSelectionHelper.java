package org.tvheadend.tvhclient.ui.features.streaming.internal.utils;
 ...
 */
final public class TrackSelectionHelper implements View.OnClickListener, DialogInterface.OnClickListener {
    ...
    private View buildView(Context context) {
        ...
        for (int groupIndex = 0; groupIndex < trackGroups.length; groupIndex++) {
            ...
            for (int trackIndex = 0; trackIndex < group.length; trackIndex++) {
                ...
                trackView.setText(ExoPlayerUtils.buildTrackName(group.getFormat(trackIndex)));
