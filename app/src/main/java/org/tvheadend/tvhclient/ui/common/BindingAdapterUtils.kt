...
import java.util.*
    ...
    fun setSeriesInfoText(view: TextView, program: Program?) {
        ...
        var seriesInfo = ""
        if (program != null) {
            if (!TextUtils.isEmpty(program.episodeOnscreen)) {
        ...
        view.visibility = if (TextUtils.isEmpty(seriesInfo)) View.GONE else View.VISIBLE
    ...
    fun setDataErrorText(view: TextView, recording: Recording?) {
        ...
        if (showRecordingFileStatus
                && recording != null
                && !TextUtils.isEmpty(recording.dataErrors)
                && (!recording.isScheduled || recording.isScheduled && recording.isRecording)) {
            view.visibility = View.VISIBLE
    ...
    fun setSubscriptionErrorText(view: TextView, recording: Recording?) {
        ...
        if (showRecordingFileStatus
                ...
                && !TextUtils.isEmpty(recording.subscriptionError)) {
            view.visibility = View.VISIBLE
    ...
    fun setStreamErrorText(view: TextView, recording: Recording?) {
        ...
        if (showRecordingFileStatus
                && recording != null
                && !recording.isScheduled
                && !TextUtils.isEmpty(recording.streamErrors)) {
            view.visibility = View.VISIBLE
    ...
    fun setFailedReasonText(view: TextView, recording: Recording?) {
        ...
        view.visibility = if (!TextUtils.isEmpty(failedReasonText)
                && recording != null
    ...
    fun setChannelName(view: TextView, name: String, iconUrl: String) {
        view.text = if (!TextUtils.isEmpty(name)) name else view.context.getString(R.string.all_channels)
