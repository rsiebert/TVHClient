    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        viewModel.removedRecordings.observe(viewLifecycleOwner, Observer { recordings ->
            ...
            if (TextUtils.isEmpty(searchQuery)) {
                ...
                toolbarInterface.setSubtitle(activity.resources.getQuantityString(R.plurals.removed_recordings, recyclerViewAdapter.itemCount, recyclerViewAdapter.itemCount))
            }
